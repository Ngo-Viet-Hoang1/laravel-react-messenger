...
class CancelExpiredPremiumPaymentsTest extends TestCase
{
    ...
    public function test_command_cancels_pending_premium_payments_after_3_hours(): void
    {
        config([
    ...
    public function test_expired_pending_payment_cannot_be_captured(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertUnprocessable()
            ->assertJsonPath('message', 'This PayPal checkout expired after 3 hours. Please start a new payment.');
