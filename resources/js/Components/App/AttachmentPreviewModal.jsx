                                ...
                                <div className="relative group h-full ">
                                    {currentIndex > 0 && (
                                        <div
                                            ...
                                            w-16 h-16 left-4 top-1/2 -translate-y-1/2 rounded-full 
                                            bg-black/50 z-30"
                                        >
                                    ...
                                    {currentIndex < previewableAttachments.length - 1 && (
                                        <div
                                            ...
                                            flex items-center justify-center w-16 h-16 right-4 top-1/2 
                                            -translate-y-1/2 rounded-full bg-black/50 z-30"
                                        >
