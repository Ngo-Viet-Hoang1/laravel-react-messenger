...
const AudioRecorder = ({ fileReady }) => {
    ...
    const onMicrophoneClick = async () => { 
        ...
        try {
            ...
            newMediaRecorder.addEventListener("stop", () => { 
                let audioBlod = new Blob(chunks, { type: "audio/ogg; codecs=opus" });
                let audioFile = new File([audioBlod], "recording.ogg", { type: "audio/ogg; codecs=opus" });
    ...
    return (
        <button onClick={onMicrophoneClick} className="p-1 text-gray-400 hover:text-gray-200">
            {recording && (<StopCircleIcon className="w-6" />)}
